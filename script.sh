...
MASON_VERSION=0.8.8.1
MASON_LIB_FILE=lib/libjace.a

. ${MASON_DIR:-~/.mason}/mason.sh

function mason_load_source {
    mason_download http://s3.amazonaws.com/geowave-rpms/release/TARBALL/geowave-0.8.8.1-24f1a85-jace-source.tar.gz \
    7f6bd7e052a2e66e0d72e7657fac689db5096643
